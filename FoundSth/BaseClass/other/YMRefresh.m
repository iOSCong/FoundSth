...
//        idleImages = [[NSArray alloc] initWithObjects:Image(@"pic_refresh_0"), Image(@"pic_refresh_1"), Image(@"pic_refresh_2"), Image(@"pic_refresh_3"), Image(@"pic_refresh_4"), Image(@"pic_refresh_5"), Image(@"pic_refresh_6"), nil];
        
        //已经到达偏移量的gif(就是已经到达偏移量的时候的gif)
//        pullingImages = [[NSArray alloc] initWithObjects:Image(@"pic_refresh_0"), Image(@"pic_refresh_1"), Image(@"pic_refresh_2"), Image(@"pic_refresh_3"), Image(@"pic_refresh_4"), Image(@"pic_refresh_5"), Image(@"pic_refresh_6"), nil];
        
        //正在刷新的时候的gif
//        refreshingImages = [[NSArray alloc] initWithObjects:Image(@"pic_refresh_0"), Image(@"pic_refresh_1"), Image(@"pic_refresh_2"), Image(@"pic_refresh_3"), Image(@"pic_refresh_4"), Image(@"pic_refresh_5"), Image(@"pic_refresh_6"), nil];
...
//        //初始化并指定方法
        tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingTarget:self refreshingAction:@selector(upDropBlockAction)];
        //指定数据加载完毕的文字
        [(MJRefreshAutoNormalFooter *)tableView.mj_footer setTitle:@"亲,这是最后一页哦 ^_^" forState:MJRefreshStateNoMoreData];
        
        
        
//        MJRefreshAutoGifFooter *footer = [MJRefreshAutoGifFooter footerWithRefreshingTarget:self refreshingAction:@selector(upDropBlockAction)];
//        [footer setImages:refreshingImages forState:MJRefreshStateRefreshing];
//        // 隐藏刷新状态的文字
////        (MJRefreshAutoGifFooter *)tableView.mj_footer.refreshingTitleHidden = YES;
//        footer.stateLabel.hidden = YES;
//        //指定数据加载完毕的文字
//        [(MJRefreshAutoGifFooter *)tableView.mj_footer setTitle:@"没有更多了!" forState:MJRefreshStateNoMoreData];
